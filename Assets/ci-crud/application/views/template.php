                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo base_url()?>template/dist/img/ap.jpeg" class="user-image" alt="User Image">
                                    <span class="hidden-xs">Putri Anugrah</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="<?php echo base_url()?>template/dist/img/ap.jpeg" class="img-circle" alt="User Image">
                                        <p>
                                            Putri Anugrah - Web Design
                                        </p>
                                    </li>
                                    <!-- Menu Body -->
                                    <li class="user-body">
